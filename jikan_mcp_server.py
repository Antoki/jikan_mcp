...
# SSL: use certifi by default; set JIKAN_MCP_INSECURE=1 to disable verification (e.g. if cert store fails)
SESSION = requests.Session()
SESSION.verify = False if os.environ.get("JIKAN_MCP_INSECURE") == "1" else certifi.where()
...
def get_full_anime_by_id(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/full")
...
def get_anime_by_id(id: int) -> dict:
    """Get anime databy id"""
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}")
    return response.json()["data"]
...
def get_anime_characters(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/characters")
    return response.json()["data"]
...
def get_anime_staff(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/staff")
    return response.json()["data"]
...
def get_anime_episodes(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/episodes")
    return response.json()["data"]
...
def get_anime_episode_by_id(id: int, episode: int) -> dict:
    """Get anime episodes by id"""
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/episodes/{episode}")
    return response.json()["data"]
...
def get_anime_news(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/news")
    return response.json()["data"]
...
def get_anime_forum(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/forum")
    return response.json()["data"]
...
def get_anime_videos(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/videos")
    return response.json()["data"]
...
def get_anime_video_episodes(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/videos/episodes")
    return response.json()["data"]
...
def get_anime_pictures(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/pictures")
    return response.json()["data"]
...
def get_anime_stats(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/statistics")
    return response.json()["data"]
...
def get_anime_more_info(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/moreinfo")
    return response.json()["data"]
...
def get_anime_recommendations(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/recommendations")
    return response.json()["data"]
...
def get_anime_user_updates(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/userupdates")
    return response.json()["data"]
...
def get_anime_user_reviews(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/reviews")
    return response.json()["data"]
...
def get_anime_relations(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/relations")
    return response.json()["data"]
...
def get_anime_themes(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/themes")
    return response.json()["data"]
...
def get_anime_external(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/external")
    return response.json()["data"]
...
def get_anime_streaming(id: int) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/anime/{id}/streaming")
    return response.json()["data"]
...
def get_season_now() -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/seasons/now")
    return response.json()["data"]
...
def get_season_anime(year: int, season: str) -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/seasons/{year}/{season}")
    return response.json()["data"]
...
def get_seasons_list() -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/seasons")
    return response.json()["data"]
...
def get_season_upcoming() -> dict:
    ...
    response = SESSION.get(f"{BASE_API_URL}/seasons/upcoming")
    return response.json()["data"]
